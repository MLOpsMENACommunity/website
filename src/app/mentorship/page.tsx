...
export default function MentorshipPage() {
  return (
    <>
            ...
            return (
              <Reveal key={o.id} delay={i * 90}>
                <div className={`card flex h-full flex-col p-7 ${a.border}`}>
                  ...
                  <h2 className="mt-5 text-xl font-bold text-white">{o.title}</h2>
                  <p className="mt-2 text-sm leading-relaxed text-slate-400">{o.blurb}</p>
      ...
      {/* ---------- Contact ---------- */}
      <section id="contact" className="scroll-mt-24 border-y border-white/10 bg-ink-950/40">
              ...
              <div className="card h-full p-6">
                ...
                <div className="mt-5 space-y-2">
                  ...
                  <a href={channels.whatsapp} target="_blank" rel="noreferrer"
                    ...
                    <span className="flex-1 text-sm text-slate-300">WhatsApp community</span>
                    <ArrowUpRight className="h-3.5 w-3.5 shrink-0 text-slate-600 transition group-hover:text-cyan-400" />
                  </a>
                </div>
              </div>
