    ...
    <>
      ...
      <section className="mx-auto max-w-content px-5 py-16 sm:px-8">
        ...
        <div aria-hidden className="relative mx-auto h-12 w-full max-w-3xl">
          ...
          <span className="absolute left-1/4 right-1/4 top-6 h-px bg-white/15" />
          <span className="absolute left-1/4 top-6 h-6 w-px bg-white/15" />
          <span className="absolute right-1/4 top-6 h-6 w-px bg-white/15" />
        </div>
        ...
        <div aria-hidden className="relative mx-auto h-12 w-full max-w-5xl">
          <span className="absolute left-1/2 top-0 h-6 w-px -translate-x-1/2 bg-white/15" />
          <span className="absolute left-[8%] right-[8%] top-6 h-px bg-white/15" />
        </div>
          ...
          {leads.map((l, i) => (
            <Reveal key={l.name} delay={i * 70}>
              <div className="relative h-full">
                <span className="absolute -top-3 left-6 z-10 grid h-7 w-7 place-items-center rounded-full border border-white/12 bg-ink-850 font-mono text-xs font-bold text-cyan-400">
                  {l.axis}
                </span>
                <MemberCard member={l} />
              </div>
